            ...
            <ul class="navbar-nav me-auto">
                ...
                <c:choose>
                    <c:when test="${pageContext.request.userPrincipal.name != null}">
                        <img style="height: 40px; width: auto" src="<c:url value="${admin.avatar}"/>" alt="Avatar">
                        <li class="nav-item">
                            <a class="nav-link" href="<c:url value="/admin" />">${pageContext.request.userPrincipal.name}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<c:url value="/admin/quanlytaikhoan" />">Quản lý tài khoản</a>
                        </li>
                        <li class="nav-item">
