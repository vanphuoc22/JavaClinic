...
<c:url value="/nurse/xemlichlam" var="action" />
<div class="content">
            ...
            <tbody>
                <c:forEach items="${lichhientai}" var="t">
                    <tr>
                        ...
                        <td>${t.shiftId.start}</td>
                        <td>${t.shiftId.end}</td>
                        <!--<td><a href="<c:url value="/nurse/xemlichlam/huy/${t.id}"/>" >Hủy</a></td>-->
                    </tr>
                </c:forEach>
            </tbody>
        </table>
            ...
            <tbody>
                <c:forEach items="${lichhientaica}" var="t">
                    <tr>
                        ...
                        <td>${t.shiftId.start}</td>
                        <td>${t.shiftId.end}</td>
                        <td class="bthuy"><button><a href="<c:url value="/nurse/xemlichlam/huy/${t.id}"/>" >Hủy</a></button></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
